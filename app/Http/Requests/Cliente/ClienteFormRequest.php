...
class ClienteFormRequest extends FormRequest{
    ...
    public function rules(){
        return [
            'nombre_cliente' => 'required|min:4|max:70|unique:tb_cliente,nombre_cliente',
            'apellido_cliente' => 'bail|required|min:4|max:70|unique:tb_cliente,email_cliente', //! bail -> anula las demás reglas 
            'tipo_cliente' => 'bail|required|not_in:0',
            'n_documento_cliente' => 'bail|required|min:4|max:10|unique:tb_cliente,n_documento_cliente',
            'n_celular_cliente' => 'bail|required|min:4|max:9|unique:tb_cliente,n_celular_cliente',
            'email_cliente' => 'bail|required|min:4|max:70|email|unique:tb_cliente,email_cliente',
        ];
    }
