...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="{{ asset('css/toastr.min.css') }}">
...
<body class="mod-bg-1 ">
            ...
            <aside class="page-sidebar">
                <div class="page-logo">
                    <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
                        ...
                        <img src="{{ asset('img/iconos/DEVC.png') }}" alt="DEVC tecnologías"
                            aria-roledescription="logo">
                        <span class="page-logo-text mr-1">DEVC tecnologías</span>
                        <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>
                        <i class="fal fa-angle-down d-inline-block ml-1 fs-lg color-primary-300"></i>
                    </a>
                </div>

                <!-- INICIO LISTA DE NAVEGACION -->
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    <div class="nav-filter">
                        <div class="position-relative">
                            <input type="text" id="nav_filter_input" placeholder="Filtra menú" class="form-control"
                                tabindex="0">
                    ...
                    <!-- class="active open"-->
                        ...
                        <li>
                            ...
                            <a href="#" title="Listado" data-filter-tags="lista">
                                <i class="fal fa-table"></i>
                                <span class="nav-link-text" data-i18n="nav.datatables">Lista</span>
                            </a>

                            <ul>
                                
                                <li class="{{ request()->routeIs('usuario.listar') ? 'active' : ''}}">
                                    <a href=" {{ url('usuario/listar') }}" title="Ver lista de usuarios"
                                        data-filter-tags="lista de usuarios">
                                        <span class="nav-link-text" data-i18n="nav.datatables_export">Usuarios</span>
                                    </a>
                                </li>

                                <li class="{{ request()->routeIs('cliente.listar') ? 'active' : ''}}">
                                    <a href=" {{ url('cliente/listar') }}" title="Ver lista de clientes"
                                        data-filter-tags="lista de clientes">
                                        <span class="nav-link-text" data-i18n="nav.datatables_export">Clientes</span>
                                    </a>
                                </li>
                        ...
                        <li>
                            ...
                            <a href="#" title="Listado" data-filter-tags="lista">
                                <i class="fal fa-table"></i>
                                <span class="nav-link-text" data-i18n="nav.datatables">Opciones</span>
                            </a>

                            <ul>
                                
                                <li class="{{ request()->routeIs('piso.listar') ? 'active' : ''}}">
                                    <a href=" {{ url('piso/listar') }}" title="Ver lista de pisos"
                                        data-filter-tags="lista de pisos">
                                        <span class="nav-link-text" data-i18n="nav.datatables_export">Piso</span>
                                    </a>
                                </li>

                                
                                <li class="{{ request()->routeIs('tipo.listar') ? 'active' : ''}}">
                                    <a href=" {{ url('tipo/listar') }}" title="Ver lista de tipos"
                                        data-filter-tags="lista de tipos">
                                        <span class="nav-link-text" data-i18n="nav.datatables_export">Tipo</span>
                                    </a>
                                </li>
            ...
            <div class="page-content-wrapper">
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                ...
                                <a class="dropdown-item fw-500 pt-3 pb-3" href="page_login-alt.html">
                                    ...
                                    <span class="float-right fw-n">&commat;ejemplo</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">DEVC tecnologías</a></li>
                        <li class="breadcrumb-item">@yield('titulo')</li>
                        <li class="breadcrumb-item active">@yield('modo')</li>
                        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span
                                class="js-get-date"></span></li>
                    </ol>
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-table'></i> @yield('modo'): <span class='fw-300'>@yield('titulo')</span>
                            <small>
                                @yield('texto')
                            </small>
                        </h1>
                                ...
                                <div class="panel-hdr">
                                    ...
                                    <div class="panel-toolbar">
                                        <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip"
                                            data-offset="0,10" data-original-title="Minimizar"></button>
                                        <button class="btn btn-panel" data-action="panel-fullscreen"
                                            data-toggle="tooltip" data-offset="0,10"
                                            data-original-title="Expandir"></button>
                                        
                                    </div>
                                </div>

                                @yield('contenido-lista')
    ...
    <!-- TODO: COMENTADO POR AHORA - ABRIR MI TABLA-->
...
-->
    ...
    <!-- 
    TODO: Scripts de la función que envía -> NUEVO, MODIFICAR, ELIMINAR, LISTAR 
    -->
    @yield('scripts')
